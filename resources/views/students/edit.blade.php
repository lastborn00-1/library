                ...
                <div class="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 space-y-6">
                    ...
                    <div class="space-y-4">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="name" value="{{ old('name', $student->name) }}" placeholder="e.g. Abdulrasheed Mohammed" class="w-full border-slate-200 rounded-xl focus:ring-indigo-500 focus:border-indigo-500 transition" required>
                        </div>
                        
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div class="space-y-2">
                                <label class="text-sm font-semibold text-slate-700">Matric Number</label>
                                <input type="text" name="student_id" value="{{ old('student_id', $student->student_id) }}" placeholder="e.g. KW/CH/2026/001" class="w-full border-slate-200 rounded-xl focus:ring-indigo-500 focus:border-indigo-500 transition" required>
                            </div>
                            <div class="space-y-2">
                                <label class="text-sm font-semibold text-slate-700">Class / Level</label>
                                <input type="text" name="class" value="{{ old('class', $student->class) }}" placeholder="e.g. ND 1" class="w-full border-slate-200 rounded-xl focus:ring-indigo-500 focus:border-indigo-500 transition" required>
                            </div>
                            <div class="space-y-2">
                                <label class="text-sm font-semibold text-slate-700">Department</label>
                                <input type="text" name="department" value="{{ old('department', $student->department) }}" placeholder="e.g. CHEW" class="w-full border-slate-200 rounded-xl focus:ring-indigo-500 focus:border-indigo-500 transition" required>
                            </div>
                        </div>

                        <div class="space-y-2">
                            <label class="text-sm font-semibold text-slate-700">Phone Number (Parent/Guardian)</label>
                            <input type="text" name="phone" value="{{ old('phone', $student->phone) }}" placeholder="e.g. +234 801 234 5678" class="w-full border-slate-200 rounded-xl focus:ring-indigo-500 focus:border-indigo-500 transition">
                        </div>
                    </div>
                </div>
